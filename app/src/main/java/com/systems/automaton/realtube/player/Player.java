package com.systems.automaton.realtube.player;
...
import static com.systems.automaton.realtube.QueueItemMenuUtil.openPopupMenu;
import static org.schabi.newpipe.extractor.ServiceList.YouTube;
import static org.schabi.newpipe.extractor.utils.Utils.isNullOrEmpty;
import static com.systems.automaton.realtube.ktx.ViewUtils.animate;
import static com.systems.automaton.realtube.ktx.ViewUtils.animateRotation;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_CLOSE;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_FAST_FORWARD;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_FAST_REWIND;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_PLAY_NEXT;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_PLAY_PAUSE;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_PLAY_PREVIOUS;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_RECREATE_NOTIFICATION;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_REPEAT;
import static com.systems.automaton.realtube.player.MainPlayer.ACTION_SHUFFLE;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_BACKGROUND;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_NONE;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_POPUP;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.buildCloseOverlayLayoutParams;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.formatSpeed;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.getMinimizeOnExitAction;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.getMinimumVideoHeight;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.getTimeString;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.globalScreenOrientationLocked;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.isPlaybackResumeEnabled;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.nextRepeatMode;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.nextResizeModeAndSaveToPrefs;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.retrievePlaybackParametersFromPrefs;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.retrievePlayerTypeFromIntent;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.retrievePopupLayoutParamsFromPrefs;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.retrieveSeekDurationFromPreferences;
import static com.systems.automaton.realtube.player.helper.PlayerHelper.savePlaybackParametersToPrefs;
import static com.systems.automaton.realtube.util.ListHelper.getPopupResolutionIndex;
import static com.systems.automaton.realtube.util.ListHelper.getResolutionIndex;
...
import com.systems.automaton.realtube.databinding.PlayerBinding;
import com.systems.automaton.realtube.databinding.PlayerPopupCloseOverlayBinding;
...
import com.systems.automaton.realtube.fragments.OnScrollBelowItemsListener;
import com.systems.automaton.realtube.fragments.detail.VideoDetailFragment;
import com.systems.automaton.realtube.info_list.StreamSegmentAdapter;
import com.systems.automaton.realtube.ktx.AnimationType;
import com.systems.automaton.realtube.local.dialog.PlaylistDialog;
import com.systems.automaton.realtube.local.history.HistoryRecordManager;
import com.systems.automaton.realtube.player.MainPlayer.PlayerType;
import com.systems.automaton.realtube.player.event.DisplayPortion;
import com.systems.automaton.realtube.player.event.PlayerEventListener;
import com.systems.automaton.realtube.player.event.PlayerGestureListener;
import com.systems.automaton.realtube.player.event.PlayerServiceEventListener;
import com.systems.automaton.realtube.player.helper.AudioReactor;
import com.systems.automaton.realtube.player.helper.LoadController;
import com.systems.automaton.realtube.player.helper.MediaSessionManager;
import com.systems.automaton.realtube.player.helper.PlayerDataSource;
import com.systems.automaton.realtube.player.helper.PlayerHelper;
import com.systems.automaton.realtube.player.listeners.view.PlaybackSpeedClickListener;
import com.systems.automaton.realtube.player.listeners.view.QualityClickListener;
import com.systems.automaton.realtube.player.mediaitem.MediaItemTag;
import com.systems.automaton.realtube.player.playback.MediaSourceManager;
import com.systems.automaton.realtube.player.playback.PlaybackListener;
import com.systems.automaton.realtube.player.playback.PlayerMediaSession;
import com.systems.automaton.realtube.player.playback.SurfaceHolderCallback;
import com.systems.automaton.realtube.player.playqueue.PlayQueue;
import com.systems.automaton.realtube.player.playqueue.PlayQueueAdapter;
import com.systems.automaton.realtube.player.playqueue.PlayQueueItem;
import com.systems.automaton.realtube.player.playqueue.PlayQueueItemBuilder;
import com.systems.automaton.realtube.player.playqueue.PlayQueueItemHolder;
import com.systems.automaton.realtube.player.playqueue.PlayQueueItemTouchCallback;
import com.systems.automaton.realtube.player.resolver.AudioPlaybackResolver;
import com.systems.automaton.realtube.player.resolver.VideoPlaybackResolver;
import com.systems.automaton.realtube.player.resolver.VideoPlaybackResolver.SourceType;
import com.systems.automaton.realtube.player.seekbarpreview.SeekbarPreviewThumbnailHelper;
import com.systems.automaton.realtube.player.seekbarpreview.SeekbarPreviewThumbnailHolder;
...
import com.systems.automaton.realtube.util.SerializedCache;
import com.systems.automaton.realtube.util.StreamTypeUtil;
import com.systems.automaton.realtube.util.external_communication.KoreUtils;
import com.systems.automaton.realtube.util.external_communication.ShareUtils;
import com.systems.automaton.realtube.views.ExpandableSurfaceView;
import com.systems.automaton.realtube.views.player.PlayerFastSeekOverlay;
