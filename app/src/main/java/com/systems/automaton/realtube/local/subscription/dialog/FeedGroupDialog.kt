package com.systems.automaton.realtube.local.subscription.dialog
...
import com.systems.automaton.realtube.databinding.DialogFeedGroupCreateBinding
import com.systems.automaton.realtube.databinding.ToolbarSearchLayoutBinding
...
import com.systems.automaton.realtube.local.subscription.dialog.FeedGroupDialog.ScreenState.DeleteScreen
import com.systems.automaton.realtube.local.subscription.dialog.FeedGroupDialog.ScreenState.IconPickerScreen
import com.systems.automaton.realtube.local.subscription.dialog.FeedGroupDialog.ScreenState.InitialScreen
import com.systems.automaton.realtube.local.subscription.dialog.FeedGroupDialog.ScreenState.SubscriptionsPickerScreen
import com.systems.automaton.realtube.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.ProcessingEvent
import com.systems.automaton.realtube.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.SuccessEvent
import com.systems.automaton.realtube.local.subscription.item.EmptyPlaceholderItem
import com.systems.automaton.realtube.local.subscription.item.PickerIconItem
import com.systems.automaton.realtube.local.subscription.item.PickerSubscriptionItem
