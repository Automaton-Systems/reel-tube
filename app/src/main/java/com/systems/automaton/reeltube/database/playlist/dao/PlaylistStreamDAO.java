...
import static com.systems.automaton.reeltube.database.playlist.PlaylistMetadataEntry.PLAYLIST_STREAM_COUNT;
import static com.systems.automaton.reeltube.database.playlist.model.PlaylistEntity.PLAYLIST_ID;
import static com.systems.automaton.reeltube.database.playlist.model.PlaylistEntity.PLAYLIST_NAME;
import static com.systems.automaton.reeltube.database.playlist.model.PlaylistEntity.PLAYLIST_TABLE;
import static com.systems.automaton.reeltube.database.playlist.model.PlaylistEntity.PLAYLIST_THUMBNAIL_URL;
import static com.systems.automaton.reeltube.database.playlist.model.PlaylistStreamEntity.JOIN_INDEX;
import static com.systems.automaton.reeltube.database.playlist.model.PlaylistStreamEntity.JOIN_PLAYLIST_ID;
import static com.systems.automaton.reeltube.database.playlist.model.PlaylistStreamEntity.JOIN_STREAM_ID;
import static com.systems.automaton.reeltube.database.playlist.model.PlaylistStreamEntity.PLAYLIST_STREAM_JOIN_TABLE;
