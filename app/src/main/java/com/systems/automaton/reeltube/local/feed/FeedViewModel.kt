package com.systems.automaton.reeltube.local.feed
...
import com.systems.automaton.reeltube.database.stream.StreamWithState
import com.systems.automaton.reeltube.local.feed.item.StreamItem
import com.systems.automaton.reeltube.local.feed.service.FeedEventManager
import com.systems.automaton.reeltube.local.feed.service.FeedEventManager.Event.ErrorResultEvent
import com.systems.automaton.reeltube.local.feed.service.FeedEventManager.Event.IdleEvent
import com.systems.automaton.reeltube.local.feed.service.FeedEventManager.Event.ProgressEvent
import com.systems.automaton.reeltube.local.feed.service.FeedEventManager.Event.SuccessResultEvent
import com.systems.automaton.reeltube.util.DEFAULT_THROTTLE_TIMEOUT
        ...
        .subscribe { (event, listFromDB, notLoadedCount, oldestUpdate) ->
            mutableStateLiveData.postValue(
                when (event) {
                    ...
                    is SuccessResultEvent -> FeedState.LoadedState(listFromDB.map { e ->
                        StreamItem(
                            e
                        )
